...
if(typeof document.body.style.maxWidth==="undefined"&&options.maxwidth){var widthSupport=function(){$this.css("width","100%");if($this.width()>maxw){$this.css("width",maxw)}};widthSupport();$(window).bind("resize",function(){widthSupport()})}})}})(jQuery,this,0);$(document).ready(function(){$('.whoweare__images').click(function(){$('.whoweare__images').removeClass('whoweare__images--active');$(this).toggleClass('whoweare__images--active')})})
...
if(typeof document.body.style.maxWidth==="undefined"&&options.maxwidth){var widthSupport=function(){$this.css("width","100%");if($this.width()>maxw){$this.css("width",maxw)}};widthSupport();$(window).bind("resize",function(){widthSupport()})}})}})(jQuery,this,0);jQuery(document).ready(function($){$(".slider__list").responsiveSlides({auto:!1,pager:!0,nav:!0,speed:500,namespace:"slider__list"})});(function(){'use strict';function scaleImageMap(){function resizeMap(){function resizeAreaTag(cachedAreaCoords,idx){function scale(coord){var dimension=(1===(isWidth=1-isWidth)?'width':'height');return padding[dimension]+Math.floor(Number(coord)*scalingFactor[dimension])}

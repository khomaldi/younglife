<div class="contact">
  ...
  <form name="contact__form" class="contact__form" action="contact.php" method="post" autocomplete="off" accept-charset="UTF-8">
    ...
    <br>
    <input type="text" class="form__input rus-font-300" name="form-name" autocomplete="off" autocapitalize="off" autocorrect="off" minlength="2"
    ...
    <br>
    <input type="text" class="form__input rus-font-300" name="form-subject" autocomplete="off" autocapitalize="off" autocorrect="off" minlength="2" maxlength="100" pattern="{L}{2,100}" placeholder="Тема сообщения" required spellcheck="true">
    <br>
    <textarea class="form__input form__textarea rus-font-300" name="form-textarea" maxlength="1234" placeholder="Введите текст сообщения..." value="" required

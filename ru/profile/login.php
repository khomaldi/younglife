...
<head>
    <!-- Title -->
    <title>Вход</title>
    <link rel="alternate" hreflang="ka" href="https://younglife.ge/profile/login.php" />
    <link rel="alternate" hreflang="ru" href="https://younglife.ge/ru/profile/login.php" />
...
<body>
 ...
 //Try to include <includes-before-content.php>
    ...
    ?>
    <?php
 //Try to include <login.html>
    try {
      if (!@include_once($rootFolder . 'ru/profile/blocks/login/login.html')) {
        throw new Exception('Can\'t open file &lt;login.html&gt;');
      }
    } catch (Exception $e) {
      echo $e->getMessage();
    }

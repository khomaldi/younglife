...
<head>
  ...
  <!-- Meta -->
  <meta charset="utf-8">
  <meta name="keywords" content="ღონისძიებები, კლუბი, ბანაკი, YoungLife, young, life, georgia, saqartvelo, საქართველო, იანგ, ლაიფი, იანგლაიფი, ოფიციალური, საიტი">
...
?>
<?php
//Try to inclide <events.html>
try {
  if (!@include_once($rootFolder . 'blocks/events/events.html')) {
    throw new Exception('Can\'t open file &lt;events.htmlgt;');
  }
 } catch (Exception $e) {
    echo $e->getMessage();
}
